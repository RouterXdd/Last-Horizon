...
public class PointStreamBulletType extends BulletType {
    public String sprite = "point-laser";
    public TextureRegion laser, laserEnd;

    public Color color = LHPal.plexLight;

    public Effect beamEffect = Fx.colorTrail;
    public float beamEffectInterval = 1.25f, beamEffectSize = 3.5f;

    public float oscScl = 2.5f, oscMag = 0.3f;
    public float additionalSize = 1.5f;
    public float damageInterval = 5f;

    public float shake = 0f;

    public PointStreamBulletType(){
    ...
    public void draw(Bullet b){
        super.draw(b);
        Draw.color(color);
        Drawf.buildBeam(b.x, b.y, b.aimX, b.aimY, b.fslope() * (1f - oscMag + Mathf.absin(Time.time, oscScl, oscMag)) + additionalSize);
